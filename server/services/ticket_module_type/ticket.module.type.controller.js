...
const TicketModuleTypeController = {
    ...
    update: async (req, res) => {
        try {
            ...
            const updatedRowsCount = await  TicketModuleTypeService.updateService(id, data);
            // if (updatedRowsCount > 0) {
            //     const newData = await  TicketModuleTypeService.getServiceById(id);
    ...
    getAllByView: async (req, res) => {
        try {
            ...
            // if(fileStatus==false){
            //   const DataToSave=await  TicketModuleTypeService.getAllService()
    ...
    deleteData: async (req, res) => {
        try {
            ...
            const deleteData = await  TicketModuleTypeService.deleteByid(id, req, res)
...
export default TicketModuleTypeController