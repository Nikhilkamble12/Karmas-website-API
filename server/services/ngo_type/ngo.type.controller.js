...
const ngoTypeController = {
    ...
    update: async (req, res) => {
        try {
            ...
            const updatedRowsCount = await ngoTypeService.updateService(id, data);
            // if (updatedRowsCount > 0) {
            //     const newData = await ngoTypeService.getServiceById(id);
    ...
    getAllByView: async (req, res) => {
        try {
            ...
            // if(fileStatus==false){
            //   const DataToSave=await ngoTypeService.getAllService()
    ...
    deleteData: async (req, res) => {
        try {
            ...
            const deleteData = await ngoTypeService.deleteByid(id, req, res)
...
export default ngoTypeController
