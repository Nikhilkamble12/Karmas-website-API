...
const CountryMasterController = {
    ...
    update: async (req, res) => {
        try {
            ...
            const updatedRowsCount = await countryMasterService.updateService(id, data);
            // if (updatedRowsCount > 0) {
            //     const newData = await countryMasterService.getServiceById(id);
    ...
    getAllByView: async (req, res) => {
        try {
            ...
            // if(fileStatus==false){
            //   const DataToSave=await countryMasterService.getAllService()
    ...
    deleteData: async (req, res) => {
        try {
            ...
            const deleteData = await countryMasterService.deleteByid(id, req, res)
...
export default CountryMasterController