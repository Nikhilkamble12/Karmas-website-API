...
const RequestTypeController = {
    ...
    update: async (req, res) => {
        try {
            ...
            const updatedRowsCount = await RequestTypeService.updateService(id, data);
            // if (updatedRowsCount > 0) {
            //     const newData = await RequestTypeService.getServiceById(id);
    ...
    getAllByView: async (req, res) => {
        try {
            ...
            // if(fileStatus==false){
            //   const DataToSave=await RequestTypeService.getAllService()
    ...
    deleteData: async (req, res) => {
        try {
            ...
            const deleteData = await RequestTypeService.deleteByid(id, req, res)
