import NgoFundSDetailsService from "./ngo.funds.details.service.js";
import commonPath from "../../middleware/comman_path/comman.path.js";
const {commonResponse,responseCode,responseConst,logger,tokenData,currentTime,addMetaDataWhileCreateUpdate} = commonPath

const NgoFundsDetailsController = {
     // Create A new Record 
     create: async (req, res) => {
        try {
            ...
            const createData = await NgoFundSDetailsService.createService(data);
            if (createData) {
                return res
    ...
    update: async (req, res) => {
        try {
            ...
            const updatedRowsCount = await NgoFundSDetailsService.updateService(id, data);
            // if (updatedRowsCount > 0) {
            //     const newData = await NgoFundSDetailsService.getServiceById(id);
    ...
    getAllByView: async (req, res) => {
        try {
            ...
            const getAll = await NgoFundSDetailsService.getAllService()

            // const fileStatus=await CommanJsonFunction.checkFileExistence(CITY_FOLDER,CITY_JSON)
            // // Store the data in JSON for future retrieval
            // if(fileStatus==false){
            //   const DataToSave=await NgoFundSDetailsService.getAllService()
    ...
    getByIdByView: async (req, res) => {
        try {
            ...
            const getDataByid = await NgoFundSDetailsService.getServiceById(Id)
    ...
    deleteData: async (req, res) => {
        try {
            ...
            const deleteData = await NgoFundSDetailsService.deleteByid(id, req, res)
    ...
    },createOrUpdateNgoFundsDetails:async(req,res)=>{
        try{
            const data = req.body
...
export default NgoFundsDetailsController
