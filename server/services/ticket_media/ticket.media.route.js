...
import TicketMediaController from "./ticket.media.controller.js";
import commonPath from "../../middleware/comman_path/comman.path.js"; // Import common paths and utilities
const {express,verifyToken,basePathRoute,multer,path,fs} = commonPath

// Define the base path for routes
const basePath=`${basePathRoute}/ticket_media`
...
router.get(
    `${basePath}`,
    verifyToken,
    TicketMediaController.getAllByView
)
...
router.get(
    `${basePath}/getById`,
    verifyToken,
    TicketMediaController.getByIdByView
)
...
router.delete(
    `${basePath}/delete`,
    verifyToken,
    TicketMediaController.deleteData
)
...
router.post(
    ...
    TicketMediaController.BulkCreateOrUpdateTicketMedia // Controller function that handles the creation logic
  );

// Route to get data by ticket ID
router.get(
    `${basePath}/getData/ByTicketId`,
    verifyToken,
    TicketMediaController.getDataByTicketId
)
