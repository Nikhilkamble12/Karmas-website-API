...
const StatusMasterController = {
    ...
    update: async (req, res) => {
        try {
            ...
            const updatedRowsCount = await StatusMasterService.updateService(id, data);
            // if (updatedRowsCount > 0) {
            //     const newData = await StatusMasterService.getServiceById(id);
    ...
    getAllByView: async (req, res) => {
        try {
            ...
            // if(fileStatus==false){
            //   const DataToSave=await StatusMasterService.getAllService()
    ...
    deleteData: async (req, res) => {
        try {
            ...
            const deleteData = await StatusMasterService.deleteByid(id, req, res)
    ...
    },getDataByParentId:async(req,res)=>{
        try{
            const Id = req.query.id
            // Fetch data by ID from JSON
            // const getJsonDatabyId=await CommanJsonFunction.getFirstDataByField(CITY_FOLDER,CITY_JSON,"city_id",Id)
...
export default StatusMasterController