...
const BonusMasterController = {
    ...
    create: async (req, res) => {
        try {
            ...
            const createData = await BonusMasterService.createService(data);
            if (createData) {
                return res
    ...
    getAllByView: async (req, res) => {
        try {
            ...
            const getAll = await BonusMasterService.getAllService()

            // const fileStatus=await CommanJsonFunction.checkFileExistence(CITY_FOLDER,CITY_JSON)
            // // Store the data in JSON for future retrieval
            // if(fileStatus==false){
            //   const DataToSave=await BonusMasterService.getAllService()
    ...
    deleteData: async (req, res) => {
        try {
            ...
            const deleteData = await BonusMasterService.deleteByid(id, req, res)
...
export default BonusMasterController
