...
let AuthController = {
  ...
  //   try {
  //     const { user_name, password, google_id, web_token, android_token } =
  //       req.body;

  //     let userData;
  //     // if google id -> fetch by googleid
  //     if (google_id) {
  //       userData = await AuthService.checkWetherUserIsPresertByGoogleId(
  //         google_id.trim()
  //       );
  //     } else {
  ...
  //       logger.error(
  //         `User with name or Id ${user_name || google_id} not found`
  //       );
  //       return res
  ...
  //     }
  //     await UserTokenService.CreateOrUpdateUserToken(
  //       userData.user_id,
  //       DataToUpdate
  //     );
  ...
  //         await GroupRolePagePermissionService.getByRoleIdAndNgoLevelId(
  //           userData.role_id,
  //           userData.ngo_level_id
  //         );
  //     }
  //     const getMenuByRoleId = await RoleMasterService.getServiceById(
  //       userData.role_id
  //     );
  //     const CommonGroupRolePagePermission =
  //       await GroupRolePagePermissionService.getDataByRoleId(userData.role_id);
  //     if (userData?.first_time_login == true) {
  //       const getBonusData =
  //         await BonusMasterService.getBonusMasterDataByCategoryStatus(
  ...
  //         const createGitScore = await ScoreHistoryService.createService(
  //           git_score
  //         );
  ...
  //         await addMetaDataWhileCreateUpdate(
  //           updateUserActivity,
  //           req,
  //           res,
  //           true
  //         );
  //         const updateUserActivityData = await UserActivtyService.updateService(
  //           getPreviousBonus[0].user_activity_id,
  //           updateUserActivity
  //         );
  //         const updateuser = await UserMasterService.updateService(
  //           userData.user_id,
  //           { first_time_login: false, total_score: totalScore }
  //         );
  //       }
  //     }
