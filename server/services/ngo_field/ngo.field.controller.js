...
const NgoFieldController = {
    ...
    update: async (req, res) => {
        try {
            ...
            const updatedRowsCount = await NgoFieldsService.updateService(id, data);
            // if (updatedRowsCount > 0) {
            //     const newData = await NgoFieldsService.getServiceById(id);
    ...
    getAllByView: async (req, res) => {
        try {
            ...
            // if(fileStatus==false){
            //   const DataToSave=await NgoFieldsService.getAllService()
    ...
    deleteData: async (req, res) => {
        try {
            ...
            const deleteData = await NgoFieldsService.deleteByid(id, req, res)
...
export default NgoFieldController