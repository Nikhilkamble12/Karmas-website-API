...
const ViewFieldTableWise = {
    ...
    USER_MASTER_WITHOUT_PASSWORD : ` SELECT  user_id, user_name, full_name, role_id, role, designation_id, designation_name, is_account_public, email_id, mobile_no, gender, bio, enrolling_date, ngo_id, ngo_name, ngo_unique_id, file_name, file_path, bg_image, bg_image_path,
     google_id, is_active, first_time_login, is_blacklisted, ngo_level_id, blacklist_reason, total_follower, total_score, blacklisted_by, total_scores_no, is_authenticated, follower_no, created_at FROM ${VIEW_NAME.GET_ALL_USER_MASTER} `,
