...
const ViewFieldTableWise = {
    ...
    DESIGNATION_GROUP_PAGE_PERMSIION_FIELDS:` SELECT designation_page_permission_id, designation_id, ngo_designation_id, designation_name, page_id, page_url, page_name, permission, description, is_active, created_by FROM ${VIEW_NAME.GET_ALL_DESIGNATION_GROUP_PAGE_PERMISSION} `,
    ...
    NGO_REQUEST_MAPPING_FIELDS: ` SELECT Request_Ngo_Id, RequestId, RequestName, request_user_id, user_name, ngo_id, ngo_name, ngo_logo_path, status_id, status_name, Reason, AssignedDate, ApprovalDate, ngo_document_required, ngo_document_uploaded FROM ${VIEW_NAME.GET_ALL_NGO_REQUEST} `,
