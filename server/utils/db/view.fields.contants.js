...
const ViewFieldTableWise = {
    ...
    //-------> G
    GIFT_MASTER_FIELDS:` SELECT gift_master_id, company_id, gift_name, company_logo, company_logo_path, gift_score_required, gift_amount, gift_t_c, how_to_redeem, is_active, created_by FROM ${VIEW_NAME.GET_ALL_GIFT_MASTER} `,
    ...
    //  ------> R 
    REQUEST_FIELDS:` SELECT RequestId, request_user_id, request_user_name, request_user_file_path, RequestName, Age, Gender, SahaykaPhoneNo, SahaykaEmailID, category_id, category_name, Address, Pincode, Remark, Story, Problem, Solution, MessageToSahayak, RejectRemark, AssignedNGO, AssignedNGOName, CityId, City, DistrictId, District, StateId, State, CountryId, Country, status_id, Status, request_type_id, request_type_name, is_user_tagged, total_likes, total_comments, is_active, is_blacklist, created_by, created_at, modified_by, modified_at FROM ${VIEW_NAME.GET_ALL_REQUEST} `,
