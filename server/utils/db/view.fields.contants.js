...
const ViewFieldTableWise = {
    ...
    DESIGNATION_GROUP_PAGE_PERMSIION_FIELDS:` SELECT designation_page_permission_id, ngo_designation_id, ngo_id, designation_name, page_id, page_url, page_name, permission, description, is_active, created_by FROM ${VIEW_NAME.GET_ALL_DESIGNATION_GROUP_PAGE_PERMISSION} `,
    ...
    NGO_MASTER_FIELDS: ` SELECT ngo_id, unique_id, darpan_reg_date, ngo_name, ngo_type, ngo_type_name, registration_no, act_name, city_of_registration_id, city_of_registration_name, state_of_registration_id, state_of_registration_name, is_blacklist, blacklist_reason, country_of_registration_id, country_of_registration_name, date_of_registration, address, city_id, city_name, state_id, state_name, country_id, country_name, telephone, mobile_no, website_url, email, ngo_logo, ngo_logo_path, pan_cad_file_name, pan_card_file_url, crs_regis_file_name, crs_regis_file_path, digital_signature_file_name, digital_signature_file_path, stamp_file_name, stamp_file_path, is_active, total_request_assigned, total_request_completed, total_request_rejected, ngo_community_id, remarks, total_ngo_likes, status_id, status_name FROM ${VIEW_NAME.GET_ALL_NGO_MASTER} `,
    ...
    NGO_REQUEST_DOCUMENT_CATEGORY: ` SELECT categrory_document_id, ngo_id, category_id, document_type_id, document_type, is_mandatory, is_active FROM ${VIEW_NAME.GET_ALL_NGO_REQUEST_DOCUMENT_CATEGORY} `,
    ...
    //  ------> R 
    REQUEST_FIELDS: ` SELECT RequestId, request_user_id, ngo_id_created, request_user_name, request_user_file_path, RequestName, Age, Gender, SahaykaPhoneNo, SahaykaEmailID, category_id, category_name, Address, Pincode, Remark, Story, Problem, Solution, MessageToSahayak, RejectRemark, AssignedNGO, AssignedNGOName, CityId, City, DistrictId, District, StateId, State, CountryId, Country, status_id, status_name, request_type_id, request_type_name, is_user_tagged, total_likes, total_comments, ngo_user_approved_id, ngo_user_approved_name, is_active, is_blacklist, created_by, created_at FROM ${VIEW_NAME.GET_ALL_REQUEST} `,
    REQUEST_FIELDS_LIMITED: ` SELECT RequestId, request_user_id, request_user_name, RequestName, request_type_id, request_type_name, AssignedNGO, AssignedNGOName, category_id, category_name, status_id, status_name, total_likes, total_comments, CityId, City, DistrictId, District, StateId, State FROM ${VIEW_NAME.GET_ALL_REQUEST} `,
    REQUEST_NGO_FIELDS: ` SELECT Request_Ngo_Id, RequestId, RequestName, request_user_id, category_id, user_name, ngo_id, ngo_name, ngo_logo_path, status_id, status_name, Reason, AssignedDate, ApprovalDate, ngo_document_required, ngo_document_uploaded FROM ${VIEW_NAME.GET_ALL_NGO_REQUEST} `,
    ...
    USER_MASTER_WITHOUT_PASSWORD : ` SELECT  user_id, user_name, full_name, role_id, role, is_account_public, email_id, mobile_no, gender, bio, enrolling_date, ngo_id, ngo_name, ngo_unique_id, file_name, file_path, bg_image, bg_image_path,
     google_id, is_active, first_time_login, is_blacklisted, ngo_level_id, blacklist_reason, total_follower, total_score, blacklisted_by, total_scores_no, is_authenticated, follower_no, created_at FROM ${VIEW_NAME.GET_ALL_USER_MASTER} `,
